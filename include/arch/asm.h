...
#define __asm_constraint__(asm_var_name, constraint, value)\
	__if_else_intl__(__is_empty__(asm_var_name))(\
...
#define __asm_out__(...) __call_va_macro__(__asm_out__, __VA_ARGS__)
...
#define __asm_def__(asm_modifiers, clobber_list, asm_out_list, asm_in_list, ...)\
		__asm__ __replace_delim__(__asm_def_expand_id__(), , asm_modifiers())(\
			__replace_delim__(__asm_def_expand_id__(), "\n\t", __VA_ARGS__)\
			__if_else_intl__(__or_intl__(__equal__(asm_modifiers, __asm_modifiers_goto__), __equal__(asm_modifiers, __asm_modifiers_volatile_goto__)))(\
				:\
				__forward__(asm_in_list)\
				__forward__(clobber_list)\
				__forward__(asm_out_list),\
				__forward__(asm_out_list)\
				__forward__(asm_in_list)\
				__forward__(clobber_list)\
			)\
...
#define __asm_inline__optimized_var(clobber_list, asm_out_list, asm_in_list, ...) __asm_def__(__asm_modifiers_none__, __forward__(clobber_list), __forward__(asm_out_list), __forward__(asm_in_list), ##__VA_ARGS__)
#define __asm_inline__volatile_var(clobber_list, asm_out_list, asm_in_list, ...) __asm_def__(__asm_modifiers_volatile__, __forward__(clobber_list), __forward__(asm_out_list), __forward__(asm_in_list), ##__VA_ARGS__)
#define __asm_inline__optimized_jmp(clobber_list, asm_out_list, asm_in_list, ...) __asm_def__(__asm_modifiers_goto__, __forward__(clobber_list), __forward__(asm_out_list), __forward__(asm_in_list), ##__VA_ARGS__)
#define __asm_inline__volatile_jmp(clobber_list, asm_out_list, asm_in_list, ...) __asm_def__(__asm_modifiers_volatile_goto__, __forward__(clobber_list), __forward__(asm_out_list), __forward__(asm_in_list), ##__VA_ARGS__)

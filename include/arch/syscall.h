...
usyscall_t<_RetType> build_syscall(syscall_type type, void* mem, _SyscallNo syscall_num, _StackClean syscall_clean = 0)
{
 ...
 */
inline syscall_t build_syscall(void* mem, syscall_no_t syscall_num, syscall_stack_clean_t syscall_clean = 0)
{
	return build_syscall<syscall_ret_t>(host_syscall_type, mem, syscall_num, syscall_clean);
}

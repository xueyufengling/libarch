...
#define __decl_syscall_info_arr__(...)\
	static const void* syscall_tpl[syscall_type::syscall_type_num] =\
	{\
		__for_each__(0)(__decl_syscall_info_arr_op_tpl__, , __VA_ARGS__)\
	};\
	static long syscall_size[syscall_type::syscall_type_num] = {\
		__for_each__(0)(__decl_syscall_info_arr_op_size__, , __VA_ARGS__)\
	};\
	static long syscall_no_offset[syscall_type::syscall_type_num] = {\
		__for_each__(0)(__decl_syscall_info_arr_op_no_offset__, , __VA_ARGS__)\
	};\
	static long syscall_cl_offset[syscall_type::syscall_type_num] = {\
		__for_each__(0)(__decl_syscall_info_arr_op_cl_offset__, , __VA_ARGS__)\
	};

__decl_syscall_info_arr__(__syscall_types_arch_os__())

#undef __decl_syscall_info_arr__
#undef __decl_syscall_info_arr_op_cl_offset__
#undef __decl_syscall_info_arr_op_no_offset__
#undef __decl_syscall_info_arr_op_size__
#undef __decl_syscall_info_arr_op_tpl__
